...
public class Devicelist_REMOVE extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPairedDevice = new ArrayAdapter<String>(this, R.layout.device_name);
		mNewDevice = new ArrayAdapter<String>(this, R.layout.device_name);
