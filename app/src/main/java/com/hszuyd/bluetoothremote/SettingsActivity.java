	...
	public static class MyPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
		...
		public boolean onPreferenceChange(Preference pref, Object newValue) {
			if (pref instanceof ListPreference) {
				SharedPreferences SharedPref = getActivity().getSharedPreferences("pref_leesplankje", MODE_PRIVATE);   // Load the preference TODO not sure about using "pref_leesplankje" right here, as it does not seem to matter, at all.
			...
			if (pref instanceof EditTextPreference) {                                           // TODO: This does not work, I don't know why.
				SharedPreferences SharedPref = getActivity().getSharedPreferences("pref_display_name", MODE_PRIVATE); // Load the preference
				...
				Log.e("asdf", "Summary should be updated...");
				return true;
			}
			return false;
		}
